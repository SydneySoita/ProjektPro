...
namespace ProjektPro.Module.BusinessObjects
{
    ...
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        ...
        {
            get => resourceName;
            set => SetPropertyValue(nameof(Name), ref resourceName, value);
        }
        ...
        {
            get => availability;
            set => SetPropertyValue(nameof(Status), ref availability, value);
        }
      ...
      /*  [Association("Project-Resource")]
        ...
        [Association("TeamMember-Resource")]
        ...
        public ProjectTask AssignedTask
        {
            get => assignedTask;
            set => SetPropertyValue(nameof(AssignedTask), ref assignedTask, value);
        }
